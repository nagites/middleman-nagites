...
require 'middleman-nagites/version'

Gem::Specification.new do |spec|
  spec.name          = 'middleman-nagites'
  spec.version       = Middleman::Nagites::VERSION
  spec.authors       = ['Avi Sumi']
  spec.email         = ['avi@nagites.com']
  spec.summary       = 'A series of helpers for consistency among Nagites\'s middleman sites'
  spec.description   = spec.summary
  spec.homepage      = 'https://github.com/nagites/middleman-nagites'
  spec.license       = 'MIT'
